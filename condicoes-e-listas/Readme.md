...
- **[condicionais-v3.html:](https://github.com/TheJessicaBohn/VueJS/blob/master/condicoes-e-listas/condicionais-v3.html)** adiciona uma div hierarquica com o `v-if`
### :book: Dicionário
...
- `v-else-if` são os casos intermediários entre o `v-if`e o `v-else`
